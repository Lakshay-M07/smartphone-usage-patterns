...
The repository includes one clean, presentation-ready visualization selected from the analysis. The remaining figures are generated by the analysis script when the project is run.

### Screen Time Breakdown by Activity
